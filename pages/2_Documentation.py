...
st.write('''The urea clearance shown in the visualizer app is computed through a support vector regression model 
         trained on synthetic data generated by a Computational Fluid Dynamics (CFD) model of the dialyzer. The CFD model 
...
st.write("For more information, check the published [article](%s) where the same methodology was applied to create a surrogate of a 1D model. Article regarding the development of the CFD surrogate model coming soon." % url)
